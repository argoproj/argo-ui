...
const navItems = [
  { path: location.pathname, title: "Sample", iconClassName: "argo-icon-docs" },
];
const breadcrumbs = [
  {
...
storiesOf("Page", module)
  .add(
    "default",
    withState({ selectedFilter: [] })(({ store }: { store: Store<any> }) => (
    ...
    <Router history={history}>
      <Route path={location.pathname}>
        <Layout navItems={navItems}>
          ...
          >
            <div style={{ padding: "1em" }}>
              <div className="white-box">Test</div>
            </div>
          </Page>
        </Layout>
      </Route>
